    ...
    jQuery('#demoN2').click(function () {
        new jBox('Notice', {
            ...
            position: {
                x: 15,
                y: 65
            }, content: '<a href = "" style = "">Venapro-Hemorrhoid Formula</a><br>Best treatmenr for hemorrhoids',
            onInit: function () {
